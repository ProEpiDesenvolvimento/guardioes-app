export default {
  ...
  register: {
    ...
    localRequired: 'Estado e Cidade devem estar preenchidos',
    nationalityRequired: 'Nacionalidade não pode ficar em Branco',
  ...
  tutorial: {
    title: 'Tutorial',
    howToUse: 'A funcionalidade básica do Guardiões da Saúde (GdS) é o reporte de saúde. Ela se encontra na Página Principal/Home, mas existem outras funcionalidades. Se quiser aprender mais, continue lendo.',
    home: "Página Inicial",
  ...
  advices: {
    ...
    redirectPermission: 'Deseja ser redirecionado para a fonte do conteúdo?',
    title: 'Dicas',
