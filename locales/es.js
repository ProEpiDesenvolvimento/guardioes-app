export default {
  ...
  share: {
    ...
    educationalInstitution: '¿Eres miembro de alguna institución educativa?',
  },
  login: {
    title: 'Entrar',
    email: 'Email',
  ...
  home: {
    ...
    offlineMessage2: 'Es posible que los datos no estén sincronizados y los cambios realizados no se guardarán.',
  },
  profiles: {
    households: 'Familia',
    title: 'Perfiles',
