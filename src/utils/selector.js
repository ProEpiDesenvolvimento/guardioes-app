...
export const countryChoices = [
    ...
    { key: 'Croácia', label: 'Croácia' },
    { key: 'Cuba', label: 'Cuba' },
    { key: 'Dinamarca', label: 'Dinamarca' },
    { key: 'Domínica', label: 'Domínica' },
    { key: 'El Salvador', label: 'El Salvador' },
    { key: 'Equador', label: 'Equador' },
    { key: 'Eslováquia', label: 'Eslováquia' },
    { key: 'Eslovênia', label: 'Eslovênia' },
    { key: 'Espanha', label: 'Espanha' },
    { key: 'Estônia', label: 'Estônia' },
    { key: 'Finlândia', label: 'Finlândia' },
    { key: 'França', label: 'França' },
    { key: 'Gabão', label: 'Gabão' },
    { key: 'Gana', label: 'Gana' },
    { key: 'Granada', label: 'Granada' },
    { key: 'Grécia', label: 'Grécia' },
    ...
    { key: 'Itália', label: 'Itália' },
    { key: 'Jamaica', label: 'Jamaica' },
    { key: 'Letônia', label: 'Letônia' },
    { key: 'Lituânia', label: 'Lituânia' },
    ...
    { key: 'República Tcheca', label: 'República Tcheca' },
    { key: 'Romênia', label: 'Romênia' },
