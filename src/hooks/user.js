...
export const UserProvider = ({ children }) => {
    ...
    const removeUserTagsfromOneSignal = () => {
        ...
        OneSignal.User.removeTag('group')
        OneSignal.User.removeTag('doses')
        OneSignal.User.removeTag('streak')
        OneSignal.User.removeTag('reported_this_week')
        OneSignal.logout()
}
    ...
    const storeLastSignal = async (lastSignalDate) => {
        ...
        OneSignal.User.addTag('reported_this_week', '1')
    }
    ...
    const storeLastReport = async (streak) => {
        ...
        OneSignal.User.addTag('streak', streak.toString())
        OneSignal.User.addTag('reported_this_week', '1')
