export default {
    ...
    selector: {
        ...
        codeFormatError: 'O código está em um formato incorreto',
        codeLengthError: 'O código deve conter pelo menos ',
    ...
    useTerms: {
        ...
        terms: {
            ...
            tituloPoliticas: 'POLÍTICAS DE USO DE DADOS PESSOAIS',
            textoPoliticas_1:
